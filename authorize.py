...
client_id, client_secret = Mastodon.create_app("Fediinforma", api_base_url=instance_url, website="https://nvda.es")
temporary_api = Mastodon(client_id=client_id, client_secret=client_secret, api_base_url=instance_url, user_agent="Fediinforma/1.0")
